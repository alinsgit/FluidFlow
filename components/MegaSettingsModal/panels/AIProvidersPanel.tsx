...
import {
  Cpu, Cloud, Server, Plus, Trash2, Check, Loader2,
  Eye, EyeOff, RefreshCw, Sparkles, ExternalLink,
  AlertCircle, CheckCircle2, Pencil, Monitor, Download,
  Zap, Key, Link2
} from 'lucide-react';
import {
...
export const AIProvidersPanel: React.FC<AIProvidersPanelProps> = ({ onProviderChange }) => {
  ...
  return (
    <div className="flex h-full">
      {/* Provider List - Left */}
      <div className="w-64 border-r border-white/5 flex flex-col bg-slate-950/30">
                      ...
                      <div className="flex items-start justify-between">
                        ...
                        <div className="flex items-center gap-1 ml-2 flex-shrink-0">
                          {model.supportsVision && (
                            <span className="text-[10px] px-1.5 py-0.5 bg-purple-500/20 text-purple-400 rounded">V</span>
                          )}
                        </div>
                      </div>
                    )}
